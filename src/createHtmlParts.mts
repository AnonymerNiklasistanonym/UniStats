// Type imports
import type { Module } from "./uniTemplate.mjs";
...
const createCellEntry = (cell: Readonly<HtmlTableCell>): string => {
  const rowSpan: string =
  ...
  const tagName: string =
    cell.headerCell !== undefined && cell.headerCell ? "th" : "td";
...
export const createTable = (
  header: ReadonlyArray<HtmlTableCell[]>,
  body: ReadonlyArray<HtmlTableCell[]>
): string => {
 ...
 */
export const createModuleEntry = (module: Readonly<Module>): string =>
